      ...
      \begin{enumerate}
        ...
        \begin{enumerate}
          ...
          \[
            f(x) = f(y) = f(x,y) > 0,
          \]
          niin $NGD(x,y)=0$. Eli $x$ ja $y$ ovat Googlen mielestä samat.
        \end{enumerate}
      \end{enumerate}
...
\label{par:aiheesta_lisaa_luettavaa}
  \begin{itemize}
    \item Geeni ilme analyysi \cite{nykter2005normalized} % TODO: Gene Expression Analysis
    \item NID:n epäapproksimoitavuus \cite{terwijn2011nonapproximability}
    \item NCD ja kuvantunnistus \cite{doi:10.1117/12.704334}
    \item Samankaltaisuus ja kohinanpoisto \cite{vitanyi2013similarity}
  \end{itemize}
