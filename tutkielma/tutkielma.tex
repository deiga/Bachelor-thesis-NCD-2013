...
\label{par:intro-1}
  ...
  % TODO: Metriikka on universaali siten, että se approksimoi parametrin, joka ilmaisee parin hallitsevan piirteen samankaltaisuutta pareittain vertailuissa.
...
\label{sec:klusterointi}
  ...
  \paragraph{TODO} % (fold)
    ...
    Klusteroinnista on usea esimerkki olemassa ja käsittelemmä tässä muutaman näistä. Ensimmäiseksi tarkastelemme musiikkigenrejen tunnistamista. Objekteiksi valittiin 12 klassista kappaletta, 12 jazz kappaletta ja 12 rock kappaletta. Tulokseksi saadun puun $S(T)$ on $0.858$. Kappaleet ryhmittyivät suurimmaksi osaksi oikeisiin katergorioihin, mutta poikkeuksiakin oli. Tämä  nähdään jo alhaisesta $S(T)$:n arvosta.

    Seuraavaksi otimme saman 12 klassisen kappaleen joukon klusteroimme ne keskenään. Puun ... arvoksi saatiin $S(T)=0.958$ ja kappaleet ryhmittyvät säveltäjän mukaan.
