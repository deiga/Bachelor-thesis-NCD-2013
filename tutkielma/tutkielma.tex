...
\label{par:muita_klusteroinnin_menetelmia}
  ...
  Vaihtoehtoisia menetelmiä ovat muun muassa: Hierarkinen klusterointi, joka ..., K-keskiö klusterointi, joka ... ja ...
  \begin{itemize}
...
\label{sub:aiheesta_lisaa_luettavaa}
  ...
  NCD:n käyttöä erilaisissa kuvantunnistusongelmissa on tutkittu, asiasta lisää \cite{doi:10.1117/12.704334}.
