...
\label{sec:klusterointi}
  ...
  \label{sub:nelikkomenetelma}
    ...
    Käsittelemme jokaista neljän objektin ryhmää $n$ kokoisesta joukosta. Näiden lukumäärä on $\binom{n}{4}$. Jokaisesta ryhmästä $u,v,w,x$ rakennamme ternääripuun, eli puu koostuu kahdesta alipuusta, joissa kummassakin 2 lapsisolmua. Tällaista puuta kutsutaan nelikkotopologiaksi \cite{CV05}. On olemassa kolme vaihtoehtoa miten tämä puu rakentuu:
    \begin{enumerate}[label=\roman*]
      \item $uv|wx$
      \item $uw|vx$
      \item $ux|vw$.
    \end{enumerate}
    Pystyviiva erottelee lapsisolmuparit eri alipuusta.

    Jokaista määrättyä puuta $T$ ja jokaista neljän lapsisolmumerkin ryhmää $u,v,w,x$ kohden sanomme että $T$ on johdonmukainen $uv|wx$:n kanssa, joss polku $u$:sta $v$:hen ei risteä polun $w$:stä $x$:än kanssa. Voimme kuvitella isomman puun rakentuvan monesta pienemmästä nelikkotopologiasta.
